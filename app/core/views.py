...
'''
@core.route('/analyze_emotion/<emotion>/', methods=['POST'])
...
@core.route('/analyze_emotion_set/<emotion_set>/', methods=['POST'])
...
@core.route('/stats/<include_word>/truncated/<truncated>')
def display_truncated_affect_word_similarities(include_word=None, truncated=None):
    result = controllers.display_affect_word_similarities(include_word=include_word, truncated=truncated)
    return jsonify(statistics = result)

@core.route('/stats/<include_word>/bounds/<upper_bound>,<lower_bound>/')
...
@core.route('/stats/<include_word>/bounds/upper/<upper_bound>/')
...
@core.route('/stats/<include_word>/bounds/lower/<lower_bound>/')
...
'''
@core.route('/stop_words/affect/bounds/<upper_bound>,<lower_bound>/')
